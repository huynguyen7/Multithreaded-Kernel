...
; Just another version trying to define words sequentially.
...
message:
    db 'Hello', 0x20 ; Define bytes array storing string `Hello World`, then terminate.
    db 'World'       ; 0x20 is the space character in ASCII.
